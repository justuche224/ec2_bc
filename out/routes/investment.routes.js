...
investmentRouter.post("/:id/status", requireAdmin, InvestmentController.updateInvestmentStatus);
investmentRouter.post("/:id/profit", requireAdmin, InvestmentController.updateInvestmentProfit);
