...
depositRouter.get("/pending-instructions", DepositController.getDepositsPendingInstructions);
depositRouter.get("/pending-instructions/detailed", DepositController.getDetailedDepositsPendingInstructions);
...
depositRouter.post("/:id/assign/cashapp", DepositController.assignCashappDetails);
