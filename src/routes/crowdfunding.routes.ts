...
crowdfundingRouter.put(
  "/settings",
  requireAdmin,
  CrowdfundingController.updateSettings
);
...
crowdfundingRouter.post(
  "/pools",
  requireAdmin,
  CrowdfundingController.createPool
);
crowdfundingRouter.get("/pools/:id", CrowdfundingController.getPool);
crowdfundingRouter.put(
  "/pools/:id",
  requireAdmin,
  CrowdfundingController.updatePool
);
crowdfundingRouter.delete(
  "/pools/:id",
  requireAdmin,
  CrowdfundingController.deletePool
);
...
crowdfundingRouter.get(
  "/my-investments",
  CrowdfundingController.getUserInvestments
);
...
crowdfundingRouter.get(
  "/investments",
  requireAdmin,
  CrowdfundingController.getAllInvestments
);
crowdfundingRouter.put(
  "/investments/:id",
  requireAdmin,
  CrowdfundingController.updateInvestment
);

// Referral routes
crowdfundingRouter.get(
  "/my-referrals",
  CrowdfundingController.getUserReferrals
);
crowdfundingRouter.post("/referrals", CrowdfundingController.createReferral);
crowdfundingRouter.put(
  "/referrals/:id/complete",
  requireAdmin,
  CrowdfundingController.markReferralComplete
);
