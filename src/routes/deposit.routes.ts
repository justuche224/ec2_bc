...
depositRouter.get(
  "/cashapp/all",
  requireAdmin,
  DepositController.getAllCashappDeposits
);
depositRouter.get(
  "/paypal/all",
  requireAdmin,
  DepositController.getAllPaypalDeposits
);
depositRouter.get(
  "/bank/all",
  requireAdmin,
  DepositController.getAllBankDeposits
);
depositRouter.get(
  "/cashapp/images/:filename",
  DepositController.serveCashappDepositProof
);
depositRouter.get(
  "/paypal/images/:filename",
  DepositController.servePaypalDepositProof
);
depositRouter.get(
  "/bank/images/:filename",
  DepositController.serveBankDepositProof
);
...
depositRouter.post(
  "/cashapp/:id/proof",
  DepositController.uploadCashappDepositProof
);
depositRouter.post(
  "/paypal/:id/proof",
  DepositController.uploadPaypalDepositProof
);
...
depositRouter.get(
  ...
  DepositController.getDepositsPendingInstructions
);
depositRouter.get(
  "/pending-instructions/detailed",
  DepositController.getDetailedDepositsPendingInstructions
);
depositRouter.get("/:id/approve", DepositController.approveDeposit);
depositRouter.get(
  "/:id/approve/cashapp",
  DepositController.approveCashappDeposit
);
depositRouter.get(
  "/:id/approve/paypal",
  DepositController.approvePaypalDeposit
);
...
depositRouter.post(
  "/:id/reject/cashapp",
  DepositController.rejectCashappDeposit
);
...
depositRouter.post(
  "/:id/fail/cashapp",
  DepositController.markCashappDepositAsFailed
);
depositRouter.post(
  "/:id/fail/paypal",
  DepositController.markPaypalDepositAsFailed
);
depositRouter.post("/:id/fail/bank", DepositController.markBankDepositAsFailed);
// Admin routes to assign payment details and send instructions
depositRouter.post(
  "/:id/assign/cashapp",
  DepositController.assignCashappDetails
);
depositRouter.post("/:id/assign/paypal", DepositController.assignPaypalDetails);
depositRouter.post("/:id/assign/bank", DepositController.assignBankDetails);
